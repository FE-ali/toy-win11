  ...
  const fetchDialogs = () => [
    ...
    },
    {
      ...
      messages: [
        ...
        {
            from: '艺珺',
            content: '组长组长 来一段自我介绍 我要放进我的假钉钉里！',
            date: '2021-11-18',
            time: '20:05:26',
        },
        {
          from: '凡颖',
          content:
            '来自上海对外经贸大学，是本小组组长<br>日语笔译专业，学习前端2年时间，擅长React<br>喜欢看书，对科技比较感兴趣',
          date: '2021-11-18',
          time: '22:04:26',
        },
      ],
    ...
    },
    {
      ...
      messages: [
        ...
        },
        {
          from: '莹雯',
          content:
            '来自华东师范大学，信号与信息处理专业，学习前端半年多，主要使用Vue，平时生活喜欢弹古筝，拼拼图。',
          date: '2021-11-18',
          time: '22:04:26',
        },
      ],
